...
public class client extends JFrame implements ActionListener {
    ...
    private JTextField employmentYearField = new JTextField();
    ...
    public client() {
        ...
        panel.add(new JLabel("Employment Year:"));
        panel.add(employmentYearField);
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        String employmentYearStr = employmentYearField.getText().trim();

        if (!birthYearStr.isEmpty() && !employmentYearStr.isEmpty()) {
            int birthYear = Integer.parseInt(birthYearStr);
            int employmentYear = Integer.parseInt(employmentYearStr);
